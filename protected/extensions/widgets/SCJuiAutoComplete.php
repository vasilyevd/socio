<?php
/**
 * SCJuiAutoComplete class file.
 */

Yii::import('zii.widgets.jui.CJuiInputWidget');

/**
 * SCJuiAutoComplete displays an autocomplete field.
 *
 * To use this widget, you may insert the following code in a view:
 * <pre>
 * $this->widget('zii.widgets.jui.SCJuiAutoComplete', array(
 *     'name'=>'city',
 ...
 */
class SCJuiAutoComplete extends CJuiInputWidget
{
	/**
	...
	* </ul>
	...
	public function run()
	{
		...
		if(isset($this->renderer))
            $js = $js.".data('autocomplete')._renderItem = ".$this->renderer;
		$js = $js.";";
