...
class STbTabs extends TbTabs
{
	...
	/**
	 * Additional class for tabs contentainer
	 */
	public $tabsContainerClass = false;
	...
	public function run()
	{
		...
		ob_start();
		$this->controller->widget('ext.widgets.STbMenu', array(
		...
		ob_start();
		echo CHtml::openTag('div', array('class'=>'tab-content'.(($this->tabsContainerClass) ? ' '.$this->tabsContainerClass : '')));
