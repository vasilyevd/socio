...
INSERT INTO `org_catorganization_direction` VALUES (31,5,3),(32,5,7),(34,3,7),(36,3,6);
...
INSERT INTO `org_docauthor` VALUES (1,'Автор тест'),(2,'автор новый'),(3,'автор ещё'),(4,'Автор другой');
...
INSERT INTO `org_donorship` VALUES (22,1,'sdfssdfsdf','2013-01-04 13:55:11',1,1,2,2013,1,NULL),(23,2,'sdfsd fsdsdfsf','2013-01-04 13:56:28',1,1,2,1998,4,24300),(27,27,'redfer essdf xexxce xoxo','2013-01-23 13:13:03',1,4,4,2010,2,NULL);
...
INSERT INTO `org_govprofile` VALUES (10,2,NULL),(11,3,1),(12,4,1),(15,1,3),(16,5,NULL),(17,6,1);
...
--
-- Table structure for table `org_infocategory`
--
...
--
-- Dumping data for table `org_infocategory`
--

LOCK TABLES `org_infocategory` WRITE;
/*!40000 ALTER TABLE `org_infocategory` DISABLE KEYS */;
/*!40000 ALTER TABLE `org_infocategory` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `org_infofile`
--
...
--
-- Dumping data for table `org_infofile`
--

LOCK TABLES `org_infofile` WRITE;
/*!40000 ALTER TABLE `org_infofile` DISABLE KEYS */;
/*!40000 ALTER TABLE `org_infofile` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `org_inforequest`
--
...
--
-- Dumping data for table `org_inforequest`
--

LOCK TABLES `org_inforequest` WRITE;
/*!40000 ALTER TABLE `org_inforequest` DISABLE KEYS */;
INSERT INTO `org_inforequest` VALUES (1,'Первый информационный запрос','Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod\r\ntempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At\r\nvero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren,\r\nno sea takimata sanctus est Lorem ipsum dolor sit amet.\r\n',1,'2013-02-19 12:31:24','2013-02-19',NULL,NULL,0,'New new new sd',6,3,'Первая полная гос. орг. sd',1);
/*!40000 ALTER TABLE `org_inforequest` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `org_inforequest_infocategory`
--
...
--
-- Dumping data for table `org_inforequest_infocategory`
--

LOCK TABLES `org_inforequest_infocategory` WRITE;
/*!40000 ALTER TABLE `org_inforequest_infocategory` DISABLE KEYS */;
/*!40000 ALTER TABLE `org_inforequest_infocategory` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `org_mmfile` VALUES (23,'50cb4c3936aa1.jpg',2,1,1,42),(24,'50cb4c3946e7d.jpg',2,2,1,42),(25,'50cb4d04294b4.jpg',2,2,1,43),(26,'50cb4d5d5d8f5.jpg',2,1,1,44),(27,'50cefba631a1e.jpg',2,1,1,45),(30,'50d08d997bc2f.doc',3,2,1,46),(46,'50d1db31e9f7e.docx',3,3,1,40),(47,'50d1db32060d0.ppt',3,1,1,40),(55,'50f698b5d26f9.jpg',2,1,0,41);
...
INSERT INTO `org_mmlink` VALUES (21,'https://github.com/vasilyevd/socio/network',1,41),(22,'http://www.youtube.com/watch?v=K7dcSr04G8s',2,40),(30,'https://github.com/vasilyevd/socio/network',1,42),(31,'https://github.com/vasilyevd/socio/network',1,43),(32,'https://github.com/vasilyevd/socio/network',1,44),(33,'https://github.com/vasilyevd/socio/network',1,45),(34,'https://github.com/vasilyevd/socio/network',1,46),(39,'https://github.com/vasilyevd/socio/new1',1,40),(47,'https://github.com/vasilyevd/socio/new',1,40);
...
INSERT INTO `org_organization_problem` VALUES (41,1,33),(42,1,41),(43,1,42),(44,1,43),(46,6,33),(47,6,34),(48,6,35),(52,7,33),(53,7,35),(54,7,37),(62,8,35),(68,11,33),(70,1,45),(71,9,40),(72,6,42),(73,8,37),(74,8,42),(78,14,33),(79,14,34);
...
INSERT INTO `user_persons` VALUES (1,'vasilyevdmitro','593c9b4a9390551d53e5cacf28ebd638','vasilyev.dmitro@gmail.com','Дмитрий','Владимирович','Васильев',1,NULL,NULL,'2012-05-14 17:54:30','11ab9b500fe9bc435e763e0779b2a959','2012-11-16 19:10:43','2012-05-25 14:47:42',NULL,NULL,'',NULL,NULL,'Instant'),(2,'vasilyev','593c9b4a9390551d53e5cacf28ebd638','vasilyev_d@mail.ru','Дмитрий','Владимирович','Васильевgg',4,NULL,NULL,'2012-05-22 22:01:14',NULL,'2012-05-22 22:01:14','2012-05-25 14:44:59',NULL,NULL,'',NULL,NULL,'Instant');
...
-- Dump completed on 2013-02-25 17:56:46
