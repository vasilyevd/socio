<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('type_group')); ?>:</b>
	<?php echo CHtml::encode($data->type_group); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('logobg')); ?>:</b>
	<?php echo CHtml::encode($data->logobg); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('logobgset')); ?>:</b>
	<?php echo CHtml::encode($data->logobgset); ?>
	<br />
